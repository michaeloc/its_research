...
params = {'gru':128,
          ...
          'classes':82,
          'epochs':100,
          'model_name':'stod_1_model_clean_data_recife.hdf5'
}
# ----------end Recife----------------------------------------------
#--------Dublin-----------------------------------------------------
...
#           'classes':66,
#           'epochs':100,
#           'model_name':'stod_1_model_clean_data_dublin.hdf5'}
#--------end Dublin-----------------------------------------------------
...
#get the pac embeddings [0-29] + timestamp [52]
    ids = list(range(30))+[52]
